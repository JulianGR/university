...
public interface Persona extends Comparable<Persona> {
	...
	/**
	 * @return El dni de la persona. El dni debe estar formado por ocho dígitos
	 *         y una letra.
	 */
	String getDNI();
	...
	/**
	 * @param dni
	 *            El nuevo D.N.I. de la persona. Debe estar formado por 8
	 *            dígitos y una letra.
	...
	/**
	 * @param fecha
	 *            Nueva fecha de nacimiento de la persona. Debe ser anterior al
	 *            día de hoy.
	 * @throws IllegalArgumentException
	...
	/**
	 * @param email Nuevo email de la persona. Debe contener una @.
	 * @throws IllegalArgumentException si el email no contiene una @.
	 */
