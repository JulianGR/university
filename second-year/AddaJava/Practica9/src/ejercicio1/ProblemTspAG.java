...
public class ProblemTspAG implements ValuesInRangeProblemAG<Ciudad, Carretera> {
	...
	public Ciudad getMax(Integer i) {
		return null;
	}

	public Ciudad getMin(Integer i) {
		return null;
	}

	public Double fitnessFunction(ValuesInRangeChromosome<Ciudad> cr) {
	...
	@Override
	public Carretera getSolucion(ValuesInRangeChromosome<Ciudad> cr) {
